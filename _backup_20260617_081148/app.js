...
const breathModes = {
  speech: {
    name: 'Thở phát âm',
    desc: 'Hít sâu bằng bụng qua mũi (4s) -> Nín giữ hơi ổn định (2s) -> Thở ra đều đặn khi phát âm từ đáy phổi (6s). Vai và lồng ngực trên giữ tĩnh lặng hoàn toàn.',
    phases: [
      { name: 'HÍT VÀO', duration: 4, class: 'inhale' },
      { name: 'NÍN GIỮ', duration: 2, class: 'hold' },
      { name: 'THỞ NÓI', duration: 6, class: 'exhale' }
    ]
  },
  vacuum: {
    name: 'Stomach Vacuum',
  ...
  valsalva: {
    ...
    desc: 'Hít sâu căng tròn bụng 360 độ (3s) -> Đóng nắp thanh quản gồng cứng thành bụng bảo vệ cột sống thắt lưng (6s) -> Thở ra mạnh qua miệng giải phóng áp lực (3s). Áp dụng khi nâng tạ nặng (Squat/Deadlift).',
    phases: [
      { name: 'HÍT NÉN', duration: 3, class: 'inhale' },
      { name: 'GỒNG NÉN', duration: 6, class: 'hold' },
      { name: 'THỞ RA', duration: 3, class: 'exhale' }
    ]
  }
};
...
function setBreathingMode(mode) {
  ...
  document.getElementById('breathModeDescription').innerHTML = `<strong>Mô tả cơ học:</strong> ${m.desc}`;
