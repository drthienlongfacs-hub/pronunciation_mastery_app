...
const EXERCISES = {
  ...
  diagnosticSentences: [
    { id: 1, text: "Ethics is the foundation of this organization. They believe in the power of thinking through every decision.", targetWords: ["ethics","this","they","the","thinking","through"], errorType: "/θ/ /ð/", severity: "🔴", ipa: "/ˈeθ.ɪks ɪz ðə faʊnˈdeɪ.ʃən əv ðɪs ˌɔːr.ɡən.aɪˈzeɪ.ʃən. ðeɪ bɪˈliːv ɪn ðə ˈpaʊ.ər əv ˈθɪŋ.kɪŋ θruː ˈev.ri dɪˈsɪʒ.ən/", tip: "ethics: lưỡi giữa răng. they/the/this/thinking/through: tất cả cần /θ/ hoặc /ð/." },
    { id: 2, text: "Corporate governance builds trust and attracts investment. It shaped how organizations risk their reputation.", targetWords: ["builds","attracts","shaped","risk"], errorType: "Final clusters", severity: "🔴", ipa: "/ˈkɔːr.pər.ət ˈɡʌv.ɚ.nəns bɪldz trʌst ənd əˈtrækts ɪnˈvest.mənt. ɪt ʃeɪpt haʊ ˌɔːr.ɡən.aɪˈzeɪ.ʃənz rɪsk ðer ˌrep.jəˈteɪ.ʃən/", tip: "builds: /ldz/. attracts: /kts/. shaped: /pt/. risk: /sk/." },
    { id: 3, text: "The PhD student published a paper on corporate policy regarding patient care.", targetWords: ["PhD","published","paper","corporate","policy","patient","care"], errorType: "Aspiration", severity: "🟡", ipa: "/ðə ˌpiː.eɪtʃˈdiː ˈstuː.dənt ˈpʌb.lɪʃt ə ˈpeɪ.pər ɑːn ˈkɔːr.pər.ət ˈpɑː.lə.si rɪˈɡɑːr.dɪŋ ˈpeɪ.ʃənt ker/", tip: "PhD: bật /p/ mạnh. paper/policy/patient: bật hơi rõ." },
    { id: 4, text: "Corporate integrity maintains the organization's urological standards.", targetWords: ["corporate","integrity","maintains"], errorType: "Word stress", severity: "🟡", ipa: "/ˈkɔːr.pər.ət ɪnˈteɡ.rə.ti meɪnˈteɪnz ðə ˌɔːr.ɡən.aɪˈzeɪ.ʃənz ˌjʊr.əˈlɑː.dʒɪ.kəl ˈstæn.dɚdz/", tip: "COR-po-rate (âm 1). in-TEG-ri-ty (âm 2). main-TAINS (âm 2)." },
    { id: 5, text: "They aim to guide the moral compass of every healthcare professional.", targetWords: ["they aim to guide","moral compass"], errorType: "Syllable fragmentation", severity: "🔴", ipa: "/ðeɪ eɪm tə ɡaɪd ðə ˈmɔːr.əl ˈkʌm.pəs əv ˈev.ri ˈhelθ.ker prəˈfeʃ.ən.əl/", tip: "Nối 'they_aim_to_guide' mượt. MO-ral COM-pass: 2 từ riêng." },
    { id: 6, text: "The distinct advantage of robust governance concludes with measurable outcomes.", targetWords: ["distinct","robust","concludes","measurable"], errorType: "Mixed", severity: "🟡", ipa: "/ðə dɪˈstɪŋkt ədˈvæn.t̬ɪdʒ əv roʊˈbʌst ˈɡʌv.ɚ.nəns kənˈkluːdz wɪð ˈmeʒ.ɚ.ə.bəl ˈaʊt.kʌmz/", tip: "dis-TINCT: /ŋkt/. ro-BUST: /st/. meas-UR-a-ble: nhấn âm 2." },
    { id: 7, text: "Whether the thesis addresses therapeutic concerns depends on thorough analysis.", targetWords: ["whether","thesis","therapeutic","thorough"], errorType: "/θ/ /ð/", severity: "🔴", ipa: "/ˈweð.ər ðə ˈθiː.sɪs əˈdres.ɪz ˌθer.əˈpjuː.t̬ɪk kənˈsɜːrnz dɪˈpendz ɑːn ˈθɝː.oʊ əˈnæl.ə.sɪs/", tip: "4 từ đều có /θ/ hoặc /ð/. Đặt lưỡi giữa răng cho mỗi từ." },
    { id: 8, text: "Stakeholders trust the system that shaped their investment risks.", targetWords: ["stakeholders","trust","shaped","risks"], errorType: "Final clusters", severity: "🔴", ipa: "/ˈsteɪkˌhoʊl.dɚz trʌst ðə ˈsɪs.təm ðæt ʃeɪpt ðer ɪnˈvest.mənt rɪsks/", tip: "trust: /st/. shaped: /pt/. risks: /sks/." },
    { id: 9, text: "A physician with empathy and ethical standards attracts respect.", targetWords: ["physician","empathy","ethical","attracts"], errorType: "Mixed", severity: "🟡", ipa: "/ə fɪˈzɪʃ.ən wɪð ˈem.pə.θi ənd ˈeθ.ɪ.kəl ˈstæn.dɚdz əˈtrækts rɪˈspekt/", tip: "empathy: /θ/ cuối. ethical: /θ/ giữa. attracts: /kts/." },
    { id: 10, text: "Three things matter: thinking clearly, acting with integrity, and speaking the truth.", targetWords: ["three","things","thinking","integrity","truth"], errorType: "/θ/ + stress", severity: "🔴", ipa: "/θriː θɪŋz ˈmæt.ər: ˈθɪŋ.kɪŋ ˈklɪr.li, ˈæk.tɪŋ wɪð ɪnˈteɡ.rə.ti, ənd ˈspiː.kɪŋ ðə truːθ/", tip: "5 từ có /θ/. integrity: in-TEG-ri-ty nhấn âm 2." },
  ],
